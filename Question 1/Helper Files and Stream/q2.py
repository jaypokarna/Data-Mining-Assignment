...
data = [['Veg Petty', 'PERK / DAIRY MILK'], ['Veg Petty', 'Samosa'], ['Veg Petty', '5STAR'], ['Veg Petty', 'OREO'], ['Veg Petty', 'DAHI BHALLA'], ['Veg Petty', '5* CRUNCHY'], ['COKE CAN 300 ML', 'CAKE SANDWICH'], ['Veg Petty', '5*'], ['COKE CAN 300 ML', 'BIS 50-50 @10'], ['COKE CAN 300 ML', 'CHCO PIE'], ['COKE CAN 300 ML', 'BIS GD CASHEW @10'], ['BOURBON 20', 'OREO'], ['CAKE SANDWICH', 'MAZZA PET 600 ML'], ['Veg Petty', 'Pasta'], ['Veg Petty', 'BOURNVILLE'], ['DAIRY MILK@35', 'PERK / DAIRY MILK'], ['COKE CAN 300 ML', 'BIS JAM TREAT @15'], ['DAIRY MILK@35', 'CAKE SANDWICH'], ['SNICKERS SNACK ', 'COKE CAN 300 ML'], ['COKE CAN 300 ML', 'SNICKERS SNACK '], ['BINOG CHIP @10', 'MAZZA PET 600 ML'], ['MAZZA PET 600 ML', 'BIS GD CASHEW @10'], ['DAIRY MILK@35', 'Samosa'], ['MAZZA PET 600 ML', 'CHCO PIE'], ['COKE CAN 300 ML', 'BOURBONE@18'], ['Veg Petty', 'DAIRY MILK@35'], ['DAIRY MILK@35', '5STAR'], ['COKE CAN 300 ML', 'BIS GD PISTA @20'], ['DAIRY MILK@35', 'CHCO PIE'], ['DAIRY MILK@35', 'BIS GD CASHEW @10'], ['DAIRY MILK@35', 'BIS 50-50 @10'], ['BINOG CHIP @10', 'DAIRY MILK@35'], ['BOURBON 20', 'BHELPURI'], ['DAIRY MILK@35', 'SNICKERS SNACK '], ['DAIRY MILK@35', 'BIS JAM TREAT @15'], ['MAZZA PET 600 ML', 'BOURBONE@18'], ['Chese Burger', 'COKE CAN 300 ML'], ['BINOG CHIP @20', 'MAZZA PET 600 ML'], ['DAIRY MILK@35', 'BOURBONE@18'], ['DAIRY MILK@35', 'BRT CAKES'], ['DAIRY MILK@35', '5* CRUNCHY'], ['COKE CAN 300 ML', 'BOURNVILLE'], ['DAIRY MILK@35', 'BIS GD PISTA @20'], ['Pasta', 'COKE CAN 300 ML'], ['DAIRY MILK@35', 'Veg Burger'], ['Chese Toast', 'MAZZA PET 600 ML'], ['MAZZA PET 600 ML', 'DARK FANTASY@25'], ['Chese Burger', 'MAZZA PET 600 ML'], ['COKE MIX 600 ML', 'COKE CAN 300 ML'], ['DAIRY MILK@35', '5*'], ['COKE CAN 300 ML', 'DUKE WAFFY BISCUIT'], ['DAIRY MILK@35', 'COKE CAN 300 ML'], ['Chese Toast', 'DAIRY MILK@35'], ['MAZZA PET 600 ML', 'BOURNVILLE'], ['COKE MIX 600 ML', 'MAZZA PET 600 ML'], ['DAIRY MILK@35', 'BOURNVILLE'], ['Pasta', 'DAIRY MILK@35'], ['MAZZA PET 600 ML', 'DUKE WAFFY BISCUIT'], ['COKE MIX 600 ML', 'DAIRY MILK@35'], ['DAIRY MILK@35', 'HOBNOBS'], ['CAKE SANDWICH', 'RED BULL'], ['Veg Petty', 'CHILLY CHICKEN '], ['BOURBON', 'RED BULL'], ['CHIPS', 'RED BULL'], ['RED BULL', 'OREO'], ['Plain Dosa', 'RED BULL'], ['RED BULL', 'BOURBONE@18'], ['COKE CAN', 'RED BULL'], ['SAMOSA CHAT', 'RED BULL'], ['WATER', 'RED BULL'], ['REAL ', 'RED BULL'], ['PULPY ORANGE', 'RED BULL'], ['DEW MIX', 'RED BULL'], ['CHI.PASTA', 'RED BULL'], ['FUNGAMA', 'RED BULL'], ['KADHAI PANEER', 'RED BULL'], ['CHILLY CHICKEN ', 'RED BULL'], ['TANDOORI FULL', 'RED BULL']]
datanew = []
...
with open(path1,'rt',encoding="latin1") as csvfile, open(path2, 'w') as wf:
